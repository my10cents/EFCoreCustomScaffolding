...
namespace Microsoft.EntityFrameworkCore.Scaffolding.Internal
{
    ...
    /// </summary>
    public class FooCSharpDbContextGenerator : ICSharpDbContextGenerator
    {
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        ///     directly from your code. This API may change or be removed in future releases.
        /// </summary>
        public FooCSharpDbContextGenerator(
#pragma warning disable CS0618 // Type or member is obsolete
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        private void GenerateDbSets(IModel model)
        {
            ...
            {
                //Garfield: DbSet<entity> entity
                var schema = entityType.Relational().Schema.Replace("dbo", "");
                var entity = entityType.Name;
                if (schema != entity)
                    _sb.AppendLine($"public virtual DbSet<{schema + entity}> {schema + entityType.Scaffolding().DbSetName} {{ get; set; }}");
                else
                    _sb.AppendLine($"public virtual DbSet<{entity}> {entityType.Scaffolding().DbSetName} {{ get; set; }}");
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        private void InitializeEntityTypeBuilder(IEntityType entityType)
        {
            if (!_entityTypeBuilderInitialized)
            {
                //Garfield: modelBuilder.Entity<Entity>(
                var schema = entityType.Relational().Schema.Replace("dbo", "");
                var entity = entityType.Name;
                ...
                if (schema != entity)
                    _sb.AppendLine($"modelBuilder.Entity<{schema + entity}>({EntityLambdaIdentifier} =>");
                else
                    _sb.AppendLine($"modelBuilder.Entity<{entity}>({EntityLambdaIdentifier} =>");
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        private void GenerateRelationship(IForeignKey foreignKey, bool useDataAnnotations)
        {
            ...
            var lines = new List<string>
            {
                //foreignKey.PrincipalToDependent.Name Garfield: WithMany Unfinished.
